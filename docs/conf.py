...
html_theme_options = {
  ...
  #'github_repo'  : 'valkka_multiprocess', # alabaster
...
htmlhelp_basename = 'valkka_multiprocess'
...
latex_documents = [
    (master_doc, 'valkka_multiprocess.tex', 'valkka_multiprocess Documentation',
...
man_pages = [
  (master_doc, 'valkka_multiprocess', 'Valkka_multiprocess Documentation',[author], 1)
]
...
texinfo_documents = [
    (master_doc, 'valkka_multiprocess', 'Valkka_multiprocess Documentation',
     author, 'Valkka_multiprocess', 'Empty python project template',
     'Miscellaneous'),
]
